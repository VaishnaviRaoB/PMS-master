...
<?php
        } // End of if statement checking if there are rows in the result
    } // End of if statement checking if the result is not empty
// End of if statement checking if the user is logged in
?>
