...
<head>
    ...
    <title>Apply For an IT Company</title>
...
<body>
    ...
    <div class="content" style="margin-top: 40px; margin-left: 20px;">
        <h2 style="margin-left: 100px;">Apply For an IT Company</h2>
    </div>
    <br><br><br><br><br>
    <form action="check.inc.php" method="POST">
        <div class="form-group col-md-3">
            ...
            <select class="custom-select" name="company" id="company">
                ...
                $sql = "SELECT name FROM company WHERE type='IT' AND status='Active';";
        ...
        <div class="form-group col-md-3">
            <input class="btn" type="submit" name="check" value="Check Eligibility" style="width: 150px; color: white; font-weight: bold; background: linear-gradient(to left, #F55197, #EE891A);">
        </div>
    </form>
