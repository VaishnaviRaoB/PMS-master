...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
  <a class="navbar-brand" href="#"><img src="../images/smv.png" style="width: 30px; height: 30px;"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="addtraining.php">Add training</a>
          <a class="dropdown-item" href="viewtraining.php">View training</a>
          <a class="dropdown-item" href="studentcourse.php"> Students joined </a>
      </li>
    </ul>
