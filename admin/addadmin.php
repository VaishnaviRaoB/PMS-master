        ...
        <form action="php/addadmin.inc.php" method="POST">
            <div class="row justify-content-center align-items-baseline">
                <div class="center one">
                    <div class="form-row">
                        <div class="form-group col-md-6 mx-5" style="position:relative;left:4rem">
                    ...
                    <div class="form-row justify-content-center">
                        <button type="submit" class="btn col-md-5" name="signup" style="margin-left: -0px; color: white; font-weight: bold; background: linear-gradient(to left, #4181ED, #3F4261);">SignUp</button>
                    </div>
                </div>
            </div>
        </form>
